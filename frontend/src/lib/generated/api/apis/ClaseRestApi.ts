...
import {
    ...
    DTORespuestaPaginadaObjectFromJSON,
    DTORespuestaPaginadaObjectToJSON,
    DTOTallerFromJSON,
    DTOTallerToJSON,
    MaterialFromJSON,
    MaterialToJSON,
...
export class ClaseRestApi extends runtime.BaseAPI {
    ...
    /**
     */
    async obtenerAlumnosDeClaseRaw(requestParameters: ObtenerAlumnosDeClaseRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DTORespuestaPaginadaObject>> {
        if (requestParameters['claseId'] == null) {
            throw new runtime.RequiredError(
                'claseId',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => DTORespuestaPaginadaObjectFromJSON(jsonValue));
    }

    /**
     */
    async obtenerAlumnosDeClase(requestParameters: ObtenerAlumnosDeClaseRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DTORespuestaPaginadaObject> {
    ...
    async obtenerClaseConDetallesParaEstudianteRaw(requestParameters: ObtenerClaseConDetallesParaEstudianteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DTOClaseConDetalles>> {
        ...
        let urlPath = `/api/clases/{claseId}/details-for-student/{alumnoId}`;
        urlPath = urlPath.replace(`{${"claseId"}}`, encodeURIComponent(String(requestParameters['claseId'])));
        urlPath = urlPath.replace(`{${"alumnoId"}}`, encodeURIComponent(String(requestParameters['alumnoId'])));
    ...
    async obtenerClaseConDetallesParaMiRaw(requestParameters: ObtenerClaseConDetallesParaMiRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DTOClaseConDetalles>> {
        ...
        let urlPath = `/api/clases/{claseId}/details-for-me`;
        urlPath = urlPath.replace(`{${"claseId"}}`, encodeURIComponent(String(requestParameters['claseId'])));
    ...
    /**
     */
    async obtenerMisClasesInscritasRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<DTOClaseInscrita>>> {
        const queryParameters: any = {};

        const headerParameters: runtime.HTTPHeaders = {};


        let urlPath = `/api/clases/mis-clases-inscritas`;
    ...
    /**
     */
    async obtenerMisClasesInscritas(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<DTOClaseInscrita>> {
    ...
    async verificarEstadoInscripcionRaw(requestParameters: VerificarEstadoInscripcionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DTOEstadoInscripcion>> {
        ...
        let urlPath = `/api/clases/{claseId}/enrollment-status/{alumnoId}`;
        urlPath = urlPath.replace(`{${"claseId"}}`, encodeURIComponent(String(requestParameters['claseId'])));
        urlPath = urlPath.replace(`{${"alumnoId"}}`, encodeURIComponent(String(requestParameters['alumnoId'])));
    ...
    async verificarMiEstadoInscripcionRaw(requestParameters: VerificarMiEstadoInscripcionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DTOEstadoInscripcion>> {
        ...
        let urlPath = `/api/clases/{claseId}/enrollment-status`;
        urlPath = urlPath.replace(`{${"claseId"}}`, encodeURIComponent(String(requestParameters['claseId'])));
