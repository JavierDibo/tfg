...
export class EnrollmentsApi extends runtime.BaseAPI {
    ...
    /**
     * Allows professors and administrators to unenroll students from classes
    ...
    /**
     * Allows professors and administrators to enroll students in classes
     ...
     */
    async obtenerMisClasesInscritas1Raw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DTOClaseInscrita<any>>> {
        const queryParameters: any = {};
     ...
     * Obtener mis clases inscritas
     */
    async obtenerMisClasesInscritas1(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DTOClaseInscrita<any>> {
