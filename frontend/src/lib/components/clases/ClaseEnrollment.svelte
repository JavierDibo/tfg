		...
		{#if showEnrollment}
			<div class="border-t border-gray-200 pt-4">
				{#if loading}
					<button
						disabled
						class="inline-flex w-full items-center justify-center rounded-md border border-transparent bg-gray-400 px-4 py-2 text-sm font-medium text-white cursor-not-allowed"
					>
