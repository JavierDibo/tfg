...
export { default as ClaseTeachers } from './ClaseTeachers.svelte';
...
export { default as ClaseStudentManagement } from './ClaseStudentManagement.svelte';
export { default as AvailableStudentsModal } from './AvailableStudentsModal.svelte';
