<script lang="ts">
	...
	const { currentFilters, paginatedData, loading = false } = $props<{
		currentFilters: any;
		paginatedData: any;
		loading?: boolean;
	}>();
...
<div class="mb-6 rounded-lg bg-white p-6 shadow-md">
	...
	<div class="mb-6 flex items-center justify-between">
		...
		<div class="flex space-x-2">
			<button
				...
				class="rounded-md px-3 py-1 text-sm transition-colors {currentFilters.searchMode === 'simple'
			...
			<button
				...
				class="rounded-md px-3 py-1 text-sm transition-colors {currentFilters.searchMode === 'advanced'
					? 'bg-blue-600 text-white'
					: 'bg-gray-200 text-gray-700 hover:bg-gray-300'}"
			>
				⚙️ Búsqueda Avanzada
	...
	{#if currentFilters.searchMode === 'simple'}
		...
		<div class="space-y-4">
			...
			<!-- Quick State Filter -->
			<div>
				<label for="matriculadoSimple" class="mb-1 block text-sm font-medium text-gray-700">Estado de Matrícula</label>
				<select
		...
		<div class="space-y-6">
			<div>
				...
				<div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
					...
					<div>
						<label for="apellidos" class="mb-1 block text-sm font-medium text-gray-700">Apellidos</label>
						<input
							id="apellidos"
							type="text"
			...
			<div>
				...
				<div>
					<label for="matriculadoAdvanced" class="mb-1 block text-sm font-medium text-gray-700">Estado de Matrícula</label>
					<select
